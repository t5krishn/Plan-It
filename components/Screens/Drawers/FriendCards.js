      ...
      {items.map((friend, i) => (
        ...
        <View style={styles.friendCard}>
          <View style={styles.upperContainer}>
            <Image
              source={{uri: friend.profile_picture || `https://api.adorable.io/avatars/111/${friend.id}`}}
            ...
            <View style={styles.friendText}>
                ...
                <Text style={[styles.friendInfoText, styles.username]}>@{friend.username}</Text>
                <Text style={[styles.friendInfoTex, styles.email]}>{friend.email}</Text>
              </View>
          </View>
          {/* {!friend.is_accepted && friend.type === "follower" && (
